...
<div class="layout-header header-portfolio">
    ...
    <div class="nav-bar">
        <ul>
            ...
            <li class="active"><a href="portfolio.html">Наши работы</a></li>
        </ul>
    </div>
...
<div class="layout-content portfolio-content">
    <div class="content-wrapper">
        <div class="layout-container portfolio-min-container">
        ...
        <div class="project-block">
            <a href="portfolio-item.html">
                <div class="img-cont">
                    <img src="images/proj-1.jpg" alt=""/>
                </div>
            </a>

            <a href="portfolio-item.html" class="proj-descr">
                Полный цыкл поддержки проекта стадиона
            </a>
            <div class="company-role">
                <span>Проектирование/Изготовление/Монтаж</span>
            </div>
        </div>
            <div class="project-block">
                <a href="portfolio-item.html">
                    <div class="img-cont">
                        <img src="<?php popel_theme_uri(); ?>/images/proj-2.jpg" alt=""/>
                    </div>
                </a>

                <a href="portfolio-item.html" class="proj-descr">
                    Монтаж и установка конструкции и стадиона
                    для событий фестиваля уличной еды
                </a>
                <div class="company-role">
                    <span>Монтаж</span>
                </div>
            ...
            <div class="project-block">
                <a href="portfolio-item.html">
                    <div class="img-cont">
                        <img src="<?php popel_theme_uri(); ?>/images/proj-3.jpg" alt=""/>
                    </div>
                </a>
                ...
                <div class="company-role">
                    <span>Изготовление/Монтаж</span>
                </div>
            </div>
            <div class="project-block">
                <a href="portfolio-item.html">
                    <div class="img-cont">
                        <img src="images/proj-4.jpg" alt=""/>
                    </div>
                </a>
        ...
        <!--<section class="application">-->
            <!--<div class="footer-footer projects-footer">-->
                    ...
                    <!--<div class="popel-agency">-->
                        ...
                        <!--<div class="svg-popel">-->
                            <!--<svg version="1.1" id="content" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px"-->
                                 <!--width="197.2px" height="14.5px" viewBox="0 0 197.2 14.5" enable-background="new 0 0 197.2 14.5" xml:space="preserve">-->
                            <!--<g>-->
                                <!--<g>-->
                                    <!--<path fill="#1E252B" d="M5.9,0H3H0v14.2h3V8.7h2.8c1.6,0,4.4-1.3,4.4-4.4C10.3,1.2,7.5,0,5.9,0 M5,6.2H3V2.6h2-->
                                        <!--c0,0,2.1-0.1,2.1,1.8C7.1,6.2,5,6.2,5,6.2"/>-->
                                    <!--<path fill="#1E252B" d="M22.9,0c-3.9,0-7.1,3.2-7.1,7.1c0,3.9,3.2,7.1,7.1,7.1c3.9,0,7.1-3.2,7.1-7.1C30.1,3.2,26.9,0,22.9,0-->
                                         <!--M22.9,11.6c-3.2,0-4-2.8-4-4.4c0-1.6,1.1-4.4,4-4.4c2.9,0,4,3,4,4.4C26.9,8.6,26.2,11.6,22.9,11.6"/>-->
                                    <!--<path fill="#1E252B" d="M42.4,0h-2.8h-3v14.2h3V8.7h2.8c1.6,0,4.4-1.3,4.4-4.4C46.9,1.2,44,0,42.4,0 M41.5,6.2h-2V2.6h2-->
                                        <!--c0,0,2.1-0.1,2.1,1.8C43.7,6.2,41.5,6.2,41.5,6.2"/>-->
                                    <!--<polygon fill="#1E252B" points="61.3,2.7 61.3,0 55.9,0 52.9,0 52.9,14.2 55.9,14.2 61.3,14.2 61.3,11.6 55.9,11.6 55.9,8.4-->
                                        <!--61.3,8.4 61.3,5.7 55.9,5.7 55.9,2.7 		"/>-->
                                    <!--<polygon fill="#1E252B" points="73.6,11.1 73.6,0 70.6,0 70.6,14.2 73.6,14.2 80.7,14.2 80.7,11.1 		"/>-->
                                <!--</g>-->
                                <!--<circle fill="#D8222A" cx="92.1" cy="7.4" r="2.3"/>-->
                                <!--<g>-->
                                    <!--<path fill="#1E252B" d="M103.3,14.2l6.4-14.1h0.9l6.3,14.1h-1l-1.9-4.1h-7.9l-1.9,4.1H103.3z M106.4,9.3h7.2l-3.6-8L106.4,9.3z"/>-->
                                    <!--<path fill="#1E252B" d="M122.3,12.4c-1.3-1.4-2-3.1-2-5.2c0-2.1,0.7-3.8,2-5.2c1.3-1.4,3-2.1,5-2.1c1.8,0,3.3,0.5,4.6,1.5v1-->
                                        <!--c-1.3-1-2.8-1.6-4.5-1.6c-1.7,0-3.2,0.6-4.4,1.8c-1.2,1.2-1.8,2.7-1.8,4.6c0,1.8,0.6,3.3,1.8,4.5c1.2,1.2,2.6,1.8,4.3,1.8-->
                                        <!--c1.9,0,3.4-0.6,4.4-1.7V6.2h0.9v6.1c-1.3,1.5-3.1,2.2-5.3,2.2C125.3,14.5,123.6,13.8,122.3,12.4z"/>-->
                                    <!--<path fill="#1E252B" d="M138.6,14.2v-14h9.4v0.9h-8.4v5.2h7v0.9h-7v6.2h8.8v0.9L138.6,14.2L138.6,14.2z"/>-->
                                    <!--<path fill="#1E252B" d="M153.2,14.2v-14h0.8l9.5,12.4V0.2h0.9v14h-0.8l-9.6-12.4v12.4H153.2z"/>-->
                                    <!--<path fill="#1E252B" d="M172.1,12.4c-1.3-1.4-2-3.1-2-5.2s0.7-3.8,2-5.2c1.3-1.4,3-2.1,5-2.1c1.5,0,2.9,0.4,4,1.1v1-->
                                        <!--c-1.2-0.8-2.5-1.2-4-1.2c-1.7,0-3.2,0.6-4.4,1.8c-1.2,1.2-1.8,2.7-1.8,4.5s0.6,3.3,1.8,4.6c1.2,1.2,2.6,1.8,4.4,1.8-->
                                        <!--c1.7,0,3.1-0.5,4.3-1.5v1c-1.2,0.9-2.6,1.3-4.3,1.3C175.1,14.5,173.5,13.8,172.1,12.4z"/>-->
                                    <!--<path fill="#1E252B" d="M190.8,14.2V7.8l-5.5-7.5h1.1l4.8,6.6l4.8-6.6h1.1l-5.5,7.5v6.5L190.8,14.2L190.8,14.2z"/>-->
                                <!--</g>-->
                            <!--</g>-->
                            <!--</svg>-->
